...
function html5blank_header_scripts() {
            ...
            wp_enqueue_script( 'swiper-script', "https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js", true );
...
function html5blank_styles() {
        ...
        wp_enqueue_style( 'google_fonts', "https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&display=swap", array(), '1.0' );
        wp_enqueue_style( 'swiper', "https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.css", array(), '1.0' );
        wp_enqueue_style( 'remixicon ', "https://cdn.jsdelivr.net/npm/remixicon@2.2.0/fonts/remixicon.css", array(), '1.0' );
        wp_enqueue_style( 'header_style', get_template_directory_uri() . "/css/header.css", array(), '1.0' );
        wp_enqueue_style( 'main_style', get_template_directory_uri() . "/css/main.css", array(), '1.0' );
}
